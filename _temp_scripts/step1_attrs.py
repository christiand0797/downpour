#!/usr/bin/env python3
"""
Add rain canvas enhancements - Step 1: Add new attributes after _afterglow_phase
"""
...
new_attrs = '''        # v29.80: Weather mode support (rain, snow, sleet)
...
idx = content.find("        self._afterglow_phase = 0\n")
if idx == -1:
    print("Marker not found")
    exit(1)

insert_pos = idx + len("        self._afterglow_phase = 0\n")
new_content = content[:insert_pos] + "\n" + new_attrs + content[insert_pos:]
