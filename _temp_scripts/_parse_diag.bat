...
echo   [DIAG] net-session gate removed
...
"!PY!" -X utf8 -X faulthandler -u -W ignore::FutureWarning "%APPDIR%downpour_v29_titanium.py" --no-admin --no-install
...
if not "!EXIT_CODE!"=="0" (
    ...
    echo   Non-zero exit - check downpour_data\logs\errors_*.log
