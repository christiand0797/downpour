rule IoT_Botnet_Generic {
    ...
    strings:
        $iot1 = "iot" nocase $iot2 = "device" nocase $iot3 = "camera" nocase $iot4 = "dvr" nocase $iot5 = "nvr" nocase $iot6 = "router" nocase $iot7 = "modem" nocase $busybox = "busybox" nocase $telnet = "telnet" nocase $wget = "wget " nocase $tftp = "tftp " nocase $shell = "/bin/sh" nocase $bash = "/bin/bash" nocase $ash = "/bin/ash" nocase condition:
...
rule Mirai_Variant_Patterns {
    ...
    strings:
        $mirai1 = "mirai" nocase $mirai2 = "mirai." nocase $mirai3 = "bot" nocase $mirai4 = "scan" nocase $mirai5 = "killer" nocase $mirai6 = "attack" nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":2323" nocase $port3 = ":5555" nocase $report = "/report" nocase $command = "/command" nocase condition:
...
rule Gafgyt_Variant_Patterns {
    ...
    strings:
        $gafgyt1 = "gafgyt" nocase $gafgyt2 = "bashlite" nocase $gafgyt3 = "lightaid" nocase $gafgyt4 = "qbot" nocase $download = "download" nocase $wget = "wget " nocase $tftp = "tftp " nocase $curl = "curl " nocase $cnc = "cnc" nocase $port = ":21" nocase $port2 = ":23" nocase $port3 = ":6667" nocase $scan = "scan" nocase $kill = "kill" nocase $brute = "brute" nocase condition:
...
rule Moobot_Patterns {
    ...
    strings:
        $moobot1 = "moobot" nocase $moobot2 = "moo" nocase $moobot3 = "bot" nocase $busybox = "busybox" nocase $telnet = "telnet" nocase $wget = "wget " nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":8888" nocase $scan = "scan" nocase $attack = "attack" nocase condition:
...
rule Amnesia_Botnet_Patterns {
    ...
    strings:
        $amnesia1 = "amnesia" nocase $amnesia2 = "amnes" nocase $amnesia3 = "bot" nocase $persistence = "/etc/init.d/" nocase $persistence2 = "/etc/rc.d/" nocase $persistence3 = "/etc/cron" nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":4444" nocase $scan = "scan" nocase $brute = "brute" nocase condition:
...
rule Hakai_Botnet_Patterns {
    ...
    strings:
        $hakai1 = "hakai" nocase $hakai2 = "hak" nocase $hakai3 = "bot" nocase $busybox = "busybox" nocase $telnet = "telnet" nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":8080" nocase $scan = "scan" nocase $attack = "attack" nocase condition:
...
rule Persira_Botnet_Patterns {
    ...
    strings:
        $persira1 = "persira" nocase $persira2 = "pers" nocase $persira3 = "bot" nocase $busybox = "busybox" nocase $telnet = "telnet" nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":6667" nocase $scan = "scan" nocase $brute = "brute" nocase condition:
...
rule Satori_Botnet_Patterns {
    ...
    strings:
        $satori1 = "satori" nocase $satori2 = "sato" nocase $satori3 = "bot" nocase $busybox = "busybox" nocase $telnet = "telnet" nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":9999" nocase $scan = "scan" nocase $attack = "attack" nocase condition:
...
rule Masuta_Botnet_Patterns {
    ...
    strings:
        $masuta1 = "masuta" nocase $masuta2 = "masu" nocase $masuta3 = "bot" nocase $busybox = "busybox" nocase $telnet = "telnet" nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":5555" nocase $scan = "scan" nocase $brute = "brute" nocase condition:
...
rule PureCryp_Botnet_Patterns {
    ...
    strings:
        $purecryp1 = "purecryp" nocase $purecryp2 = "pure" nocase $purecryp3 = "cryp" nocase $purecryp4 = "bot" nocase $busybox = "busybox" nocase $telnet = "telnet" nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":3333" nocase $scan = "scan" nocase $miner = "miner" nocase $pool = "pool." nocase condition:
...
rule Wroba_Botnet_Patterns {
    ...
    strings:
        $wroba1 = "wroba" nocase $wroba2 = "wrob" nocase $wroba3 = "bot" nocase $busybox = "busybox" nocase $telnet = "telnet" nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":1234" nocase $scan = "scan" nocase $brute = "brute" nocase $spread = "spread" nocase condition:
...
rule Yakuza_Botnet_Patterns {
    ...
    strings:
        $yakuza1 = "yakuza" nocase $yakuza2 = "yaku" nocase $yakuza3 = "bot" nocase $busybox = "busybox" nocase $telnet = "telnet" nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":7777" nocase $scan = "scan" nocase $attack = "attack" nocase $ddos = "ddos" nocase condition:
...
rule Hybrid_Botnet_Patterns {
    ...
    strings:
        $hybrid1 = "hybrid" nocase $hybrid2 = "hyb" nocase $hybrid3 = "bot" nocase $busybox = "busybox" nocase $telnet = "telnet" nocase $cnc = "cnc" nocase $port = ":23" nocase $port2 = ":6667" nocase $scan = "scan" nocase $brute = "brute" nocase $spread = "spread" nocase condition:
