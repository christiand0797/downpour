...
| 🤝 **MISP/STIX Sharing** | Import MISP event JSON / STIX 2.0 bundles / plain IOC lists into the intel DB; export the local indicator set as a MISP-format JSON event for SOC/peer sharing |
