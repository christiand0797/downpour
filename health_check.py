...
def main():
    ...
    ok = True
    for name in [
        'config', 'ai_security_engine', 'network_monitor', 'vulnerability_scanner',
        'memory_forensics', 'threat_feed_aggregator', 'threat_intelligence_updater',
        'threat_intelligence', 'enhanced_security_dashboard', 'enhanced_hardware_integration',
        'parental_controls', 'backup_verifier', 'file_scanner', 'system_cleanup'
    ]:
        try:
